  ...
  return (
    <Card className="mb-8">
      <CardHeader>
        ...
        <CardDescription>
          Having trouble with registration? Our technical support team is here to help.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="bg-gradient-to-br from-[#25D366]/10 to-[#25D366]/5 rounded-lg p-4 border border-[#25D366]/20">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-foreground mb-1">Technical Support Available</p>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Get instant assistance via WhatsApp for any registration issues, payment queries, or technical difficulties.
              </p>
            </div>
          </div>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block w-full py-2.5 px-4 bg-[#25D366] text-white rounded-lg text-sm font-semibold text-center hover:bg-[#20BA5A] transition-colors shadow-sm"
          >
